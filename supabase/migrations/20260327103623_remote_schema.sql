...
revoke delete on table "auth"."custom_oauth_providers" from "dashboard_user";

revoke insert on table "auth"."custom_oauth_providers" from "dashboard_user";

revoke references on table "auth"."custom_oauth_providers" from "dashboard_user";

revoke select on table "auth"."custom_oauth_providers" from "dashboard_user";

revoke trigger on table "auth"."custom_oauth_providers" from "dashboard_user";

revoke truncate on table "auth"."custom_oauth_providers" from "dashboard_user";

revoke update on table "auth"."custom_oauth_providers" from "dashboard_user";
...
revoke delete on table "auth"."webauthn_challenges" from "dashboard_user";

revoke insert on table "auth"."webauthn_challenges" from "dashboard_user";

revoke references on table "auth"."webauthn_challenges" from "dashboard_user";

revoke select on table "auth"."webauthn_challenges" from "dashboard_user";

revoke trigger on table "auth"."webauthn_challenges" from "dashboard_user";

revoke truncate on table "auth"."webauthn_challenges" from "dashboard_user";

revoke update on table "auth"."webauthn_challenges" from "dashboard_user";

revoke delete on table "auth"."webauthn_credentials" from "dashboard_user";

revoke insert on table "auth"."webauthn_credentials" from "dashboard_user";

revoke references on table "auth"."webauthn_credentials" from "dashboard_user";

revoke select on table "auth"."webauthn_credentials" from "dashboard_user";

revoke trigger on table "auth"."webauthn_credentials" from "dashboard_user";

revoke truncate on table "auth"."webauthn_credentials" from "dashboard_user";

revoke update on table "auth"."webauthn_credentials" from "dashboard_user";
...
drop policy "authenticated users can read team logos" on "storage"."objects";

drop policy "authenticated users can upload documents" on "storage"."objects";

drop policy "authenticated users can upload team logos" on "storage"."objects";
...
for insert
to authenticated
with check (((bucket_id = 'team-logos'::text) AND ((storage.foldername(name))[1] = 'team-logos'::text)));
